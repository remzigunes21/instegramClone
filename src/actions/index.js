...
export const loadMessages = (binId, requiredFields = []) =>
  action(LOAD_MESSAGES, {binId, requiredFields});
export const loadStories = (binId, requiredFields = []) =>
  action(LOAD_STORIES, {binId, requiredFields});
