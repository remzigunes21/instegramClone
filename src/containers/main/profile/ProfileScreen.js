...
const ProfileScreen = () => {
  const profileData = {
    ...
    bio:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi velit justo, sodales sit amet pulvinar quis, egestas eu justo. Phasellus elit volutpat..',
    statistics: {
      posts: 348,
      followers: 187,
      following: 431,
  ...
  renderProfileHeader = () => {
    return (
      <View style={styles.bioContainer}>
        ...
        <Text
          style={styles.link}
          onPress={() => Linking.openURL(profileData.url)}>
          {profileData.url}
        </Text>
